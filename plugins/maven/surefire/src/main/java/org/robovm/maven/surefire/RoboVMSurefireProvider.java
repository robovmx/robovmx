...
public class RoboVMSurefireProvider extends AbstractProvider {
    ...
    private Config.Builder createConfig(final ConsoleLogger consoleLogger) throws IOException {
        ...
        configBuilder.addClasspathEntry(roboVMResolver.resolveArtifact("com.robovmx:robovm-junit-server:" + Version.getCompilerVersion()).asFile());
        if(isIOS()) {
            configBuilder.addClasspathEntry(roboVMResolver.resolveArtifact("com.robovmx:robovm-rt:" + Version.getCompilerVersion()).asFile());
            configBuilder.addClasspathEntry(roboVMResolver.resolveArtifact("com.robovmx:robovm-objc:" + Version.getCompilerVersion()).asFile());
            configBuilder.addClasspathEntry(roboVMResolver.resolveArtifact("com.robovmx:robovm-cocoatouch:" + Version.getCompilerVersion()).asFile());
        }
